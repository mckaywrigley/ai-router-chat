...
import { MessageCodeBlock } from "./messsage-codeblock";

interface MessageMarkdownProps extends HTMLAttributes<HTMLDivElement> {
  content: string;
}

export const MessageMarkdown: FC<MessageMarkdownProps> = ({ content, ...props }) => {
  return (
    <MessageMarkdownMemoized
      className={cn("prose dark:prose-invert prose-p:leading-relaxed prose-pre:p-0 min-w-full break-words text-black", props.className)}
